...
use sp_runtime::{
	...
	ConsensusEngineId,	// added
};
use sp_std::{prelude::*, str::FromStr};	// add str::FromStr
#[cfg(feature = "std")]
...
impl FeeCalculator for FixedGasPrice {
	fn min_gas_price() -> (U256, Weight) {
		...
		(1_000_000_000u128.into(), Weight::from_parts(7u64, 100u64))
	}
}
...
parameter_types! {
	...
	pub WeightPerGas: Weight = Weight::from_parts(20_000, 100u64);
